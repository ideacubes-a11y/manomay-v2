      ...
      <section className="py-24 bg-violet-50 text-slate-900 rounded-[3rem] mx-4 sm:mx-8 mb-12 border border-violet-100 relative overflow-hidden">
        ...
        <div className="max-w-7xl mx-auto px-6 text-center relative z-10">
          ...
          <div className="flex flex-col sm:flex-row gap-6 justify-center mt-12">
            <Link to="/contact" className="bg-brand text-white px-10 py-5 rounded-full text-xl font-bold hover:bg-brand/90 transition-all shadow-2xl shadow-brand/20">
              Audit Our Workflow
            </Link>
            <a 
              ...
              className="bg-white text-slate-900 border border-slate-200 px-10 py-5 rounded-full text-xl font-bold hover:bg-slate-50 transition-all flex items-center justify-center gap-2 shadow-sm"
            >
              Check Odoo Pricing
