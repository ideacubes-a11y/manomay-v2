      ...
      <section className="py-24 bg-white relative">
        <div className="max-w-7xl mx-auto px-6">
          ...
          >
            ...
            <Link to="/solutions/odoo-pos" className="bg-brand text-white px-10 py-5 rounded-full font-bold hover:bg-brand/90 transition-all flex items-center gap-3 whitespace-nowrap text-xl shadow-2xl shadow-brand/20 active:scale-95 group">
        ...
        <div className="bg-slate-900 rounded-[3rem] p-12 md:p-24 text-center relative overflow-hidden shadow-2xl">
          ...
          <div className="relative z-10 max-w-3xl mx-auto">
            ...
            <div className="flex flex-col sm:flex-row gap-6 justify-center mb-12">
              ...
              <Link to="/contact" className="bg-white/10 text-white backdrop-blur-md border border-white/20 px-10 py-5 rounded-full text-xl font-bold hover:bg-white/20 transition-all flex items-center justify-center gap-2 group active:scale-95">
                Get a Custom Demo
              </Link>
            </div>
          </div>
