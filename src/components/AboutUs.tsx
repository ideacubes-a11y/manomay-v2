        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-20 items-center">
          ...
          >
            ...
            <div className="relative grid grid-cols-1 sm:grid-cols-2 gap-6">
              ...
              >
                <div className="w-12 h-12 bg-slate-50 rounded-2xl flex items-center justify-center text-brand mb-4">
              ...
              >
                ...
                <div>
                  <div className="text-2xl font-bold text-white mb-2 tracking-tight leading-[1.2]">Perfect ERP Implementation<br/>& Service</div>
              ...
              >
                ...
                <div>
                  <div className="text-5xl font-bold text-slate-900 mb-2 tracking-tighter">98%</div>
                  <div className="text-[10px] font-bold text-slate-400 uppercase tracking-[0.2em]">Client Retention</div>
                </div>
              </motion.div>
            </div>
          </motion.div>
